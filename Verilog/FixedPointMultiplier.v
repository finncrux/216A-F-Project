...
module FixedPointMultiplier (
  ...
  input [8:0] PixelPort, // sfix10_En0
...
assign Output_syn = N_1;
  ...
  begin: Multiplier_25b_18f_block
    ...
    wire signed [8:0] tmpin1;
    wire signed [18:0] tmpin2;
    wire signed [8:0] tmpin1_dly;
    ...
    synDelayWithEnable #( .bitwidth(9), .preferRAMImpl(2), .delaylength(1) ) multInp1_block ( .clk(clk), .en(GlobalEnable1), .grst(GlobalResetSel), .rst(1'b0), .inp(tmpin1), .outp(tmpin1_dly) );
